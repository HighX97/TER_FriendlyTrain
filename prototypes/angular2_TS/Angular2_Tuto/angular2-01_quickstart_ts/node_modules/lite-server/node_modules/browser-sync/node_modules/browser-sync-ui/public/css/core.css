...
@font-face {
  ...
  src: url('app/html5up-alpha/assets/fonts/source-sans/sourcesanspro-it-webfont.eot');
  src: url('app/html5up-alpha/assets/fonts/source-sans/sourcesanspro-it-webfont.eot?#iefix') format('embedded-opentype'), url('app/html5up-alpha/assets/fonts/source-sans/sourcesanspro-it-webfont.woff2') format('woff2'), url('app/html5up-alpha/assets/fonts/source-sans/sourcesanspro-it-webfont.woff') format('woff'), url('app/html5up-alpha/assets/fonts/source-sans/sourcesanspro-it-webfont.ttf') format('truetype'), url('app/html5up-alpha/assets/fonts/source-sans/sourcesanspro-it-webfont.svg#source_sans_proitalic') format('svg');
  font-weight: normal;
  font-style: italic; }

@font-face {
  font-family: 'source_sans';
  src: url('app/html5up-alpha/assets/fonts/source-sans/sourcesanspro-bold-webfont.eot');
  src: url('app/html5up-alpha/assets/fonts/source-sans/sourcesanspro-bold-webfont.eot?#iefix') format('embedded-opentype'), url('app/html5up-alpha/assets/fonts/source-sans/sourcesanspro-bold-webfont.woff2') format('woff2'), url('app/html5up-alpha/assets/fonts/source-sans/sourcesanspro-bold-webfont.woff') format('woff'), url('app/html5up-alpha/assets/fonts/source-sans/sourcesanspro-bold-webfont.ttf') format('truetype'), url('app/html5up-alpha/assets/fonts/source-sans/sourcesanspro-bold-webfont.svg#source_sans_probold') format('svg');
  font-weight: bold;
  font-style: normal; }

@font-face {
  font-family: 'source_sans';
  src: url('app/html5up-alpha/assets/fonts/source-sans/sourcesanspro-regular-webfont.eot');
  src: url('app/html5up-alpha/assets/fonts/source-sans/sourcesanspro-regular-webfont.eot?#iefix') format('embedded-opentype'), url('app/html5up-alpha/assets/fonts/source-sans/sourcesanspro-regular-webfont.woff2') format('woff2'), url('app/html5up-alpha/assets/fonts/source-sans/sourcesanspro-regular-webfont.woff') format('woff'), url('app/html5up-alpha/assets/fonts/source-sans/sourcesanspro-regular-webfont.ttf') format('truetype'), url('app/html5up-alpha/assets/fonts/source-sans/sourcesanspro-regular-webfont.svg#source_sans_proregular') format('svg');
  font-weight: normal;
  font-style: normal; }
